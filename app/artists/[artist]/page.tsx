...
export default async function ArtistPage({
    ...
    return (
        <div className='mx-6 sm:mx-18'>
            <h1 className='font-sans font-bold text-[2.7rem] sm:text-5xl text-primary-light! dark:text-primary-dark! mt-5 sm:mt-15 mb-4 sm:mb-10'>
                About artist:
            </h1>
            <div className=' flex flex-col md:flex-row items-stretch gap-6'>
                ...
                <div className='flex-1 flex flex-col gap-2 p-4 max-w-full sm:max-w-full md:max-w-3/4 lg:max-w-2/3 xl:max-w-1/2 2xl:max-w-1/3 bg-primary-light/10 dark:bg-primary-dark/10 rounded-md'>
                    <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 mx-0 sm:mx-4'>
                        <p className='px-4 py-1 sm:py-3 text-primary-light dark:text-primary-dark rounded-sm overflow-hidden'>
                    ...
                    <p className='px-4 py-1 sm:py-3 mx-0 sm:mx-4 text-primary-light dark:text-primary-dark rounded-sm text-md sm:text-lg md:text-md lg:text-lg font-light'>
                    ...
                    <p className='px-4 py-1 sm:py-3 mx-0 sm:mx-4 text-primary-light dark:text-primary-dark rounded-sm'>
            ...
            <h1 className='font-sans font-bold text-[2.5rem] sm:text-5xl text-primary-light dark:text-primary-dark mt-5 sm:mt-15 mb-4 sm:mb-10'>
                Famous Artworks:
            </h1>
            <ImageMasonry 
                data={artworksData}
